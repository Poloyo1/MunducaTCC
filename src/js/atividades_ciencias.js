...
const btn_conc_att14 = document.querySelector('.btn-att14')
...
function correcao(att){
  ...
  if(att == 'att4'){
    blocosResposta = document.querySelectorAll('.resposta')
    console.log(blocosResposta)
    Respostas = ['3 meses', '1 mês', '400 anos']
    blocosResposta.forEach(bloco => {
      if( bloco.id == 'resposta10'){
        console.log(bloco)
        resposta = document.querySelector("#"+ bloco.id +" button")
        console.log(resposta)
        if(resposta.textContent == '3 meses'){
          acertos +=1
          console.log(acertos)
        }
        ...
        resposta = document.querySelector("#"+ bloco.id +" button")
        console.log(resposta)
        if(resposta.textContent == '400 anos'){
          acertos +=1
          console.log(acertos)
        }
      } 
  ...
  if(att == 'att12'){
    blocosResposta = document.querySelectorAll('.resposta')
    console.log(blocosResposta)
    Respostas = ['Cabeça', 'Braços', 'Pernas']
    blocosResposta.forEach(bloco => {
      if( bloco.id == 'resposta13'){
        console.log(bloco)
        resposta = document.querySelector("#"+ bloco.id +" button")
        console.log(resposta)
        if(resposta.textContent == 'Cabeça'){
          acertos +=1
          console.log(acertos)
        }
      } else if( bloco.id == 'resposta14'){
        console.log(bloco)
        resposta = document.querySelector("#"+ bloco.id +" button")
        console.log(resposta)
        if(resposta.textContent == 'Braços'){
          acertos +=1
          console.log(acertos)
        }
        ...
        resposta = document.querySelector("#"+ bloco.id +" button")
        console.log(resposta)
        if(resposta.textContent == 'Pernas'){
          acertos +=1
          console.log(acertos)
        }
      } 
...
// aqui acaba a primeira atividade
